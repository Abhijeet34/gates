...
gates has one maintainer, so each kind of question has exactly one place to go.

## Something is broken

[Open a bug report](https://github.com/Abhijeet34/gates/issues/new?template=bug.yml).
...
[Open a feature request](https://github.com/Abhijeet34/gates/issues/new?template=feature.yml).
Describe what you were trying to get done before describing what you want added.

## How it works

`README.md` covers what gates is and how to use it, and `AGENTS.md` covers how it is built and tested.
